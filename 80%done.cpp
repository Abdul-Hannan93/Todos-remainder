...
void iDraw()
{
	...
	if (settings_mode == 0 && mood == 0 && ringtone_mood == 0 && show_reminder==0 && add_task == 0 && guideline == 0)
	{
		...
		iText(160, 260, "History about the activity your past avtivity", GLUT_BITMAP_TIMES_ROMAN_24);
        ...
        if ((hours == hour) && (minutes == minute) && (days == day) && ((months + 1) == month) && ((years + 1900) == year))
			{
                iSetColor(102, 0, 0);
                iRectangle(300, 50, 60, 40);

		        iText(308, 62, "OFF", GLUT_BITMAP_TIMES_ROMAN_24);
	...
	if (settings_mode == 0 && mood == 0 && ringtone_mood == 0 && show_reminder == 0 && add_task == 1)
	{
		...
		// iFilledRectangle(130, 320, 450, 40);
		iSetColor(150, 150, 150);
		...
		// iSetColor(0, 0, 0);
		// iText(150, 335, str2, GLUT_BITMAP_TIMES_ROMAN_24);
    ...
    if (settings_mode == 0 && mood == 0 && ringtone_mood == 0 && show_reminder == 1 && add_task == 0)
    {
        ...
        // 	iSetColor(102, 0, 0);
        //      FILE* fp3;
        // char filename[100] = "TodosReminder.txt";
...
void iMouse(int button, int state, int mx, int my)
{
    ...
    if ((button == GLUT_LEFT_BUTTON) && (mx >= 50) && (mx <= 200) && (my >= 240) && (my <= 280))
	{
     ...
     if ((button == GLUT_LEFT_BUTTON) && (mx >= 300) && (mx <= 360) && (my >= 50) && (my <= 90)&&(hours == hour) && (minutes == minute) && (days == day) && ((months + 1) == month) && ((years + 1900) == year))
	{
		hour++;
